...
const file_capabilities_networking_http_v1alpha_client_proto_rawDesc = "" +
	"\n" +
	"1capabilities/networking/http/v1alpha/client.proto\x12$capabilities.networking.http.v1alpha\x1a*tools/generator/v1alpha/cre_metadata.proto\"\xf8\x01\n" +
	"\aRequest\x12\x10\n" +
	...
	"statusCode\x12U\n" +
	"\aheaders\x18\x03 \x03(\v2;.capabilities.networking.http.v1alpha.Response.HeadersEntryR\aheaders\x12\x12\n" +
...
var file_capabilities_networking_http_v1alpha_client_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_capabilities_networking_http_v1alpha_client_proto_goTypes = []any{
	(*Request)(nil),  // 0: capabilities.networking.http.v1alpha.Request
	(*Response)(nil), // 1: capabilities.networking.http.v1alpha.Response
	nil,              // 2: capabilities.networking.http.v1alpha.Request.HeadersEntry
	nil,              // 3: capabilities.networking.http.v1alpha.Response.HeadersEntry
}
var file_capabilities_networking_http_v1alpha_client_proto_depIdxs = []int32{
	2, // 0: capabilities.networking.http.v1alpha.Request.headers:type_name -> capabilities.networking.http.v1alpha.Request.HeadersEntry
	3, // 1: capabilities.networking.http.v1alpha.Response.headers:type_name -> capabilities.networking.http.v1alpha.Response.HeadersEntry
	0, // 2: capabilities.networking.http.v1alpha.Client.SendRequest:input_type -> capabilities.networking.http.v1alpha.Request
	1, // 3: capabilities.networking.http.v1alpha.Client.SendRequest:output_type -> capabilities.networking.http.v1alpha.Response
