module github.com/smartcontractkit/capabilities/loadtestproxy

go 1.23.4

require (
	github.com/google/uuid v1.6.0
	github.com/smartcontractkit/capabilities/libs/loopserver v0.0.0-20250203133225-e8b78a21b9d2
