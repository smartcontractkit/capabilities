...
func sizeOfNewMapElement(mapKeyID int, key string, value proto.Message) int {
...
func hasCapacityToAdd(currentSize, mapKeyID int, key string, value proto.Message, maxSize int) (int, bool) {
