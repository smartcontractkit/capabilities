// Conversions between this capability's protos and the EVM types chainlink-common
// describes a chain with. Copied from chainlink-common's own copy of these protos
// (pkg/capabilities/v2/chain-capabilities/evm), which is generated from the same
// .proto this capability now generates for itself.
