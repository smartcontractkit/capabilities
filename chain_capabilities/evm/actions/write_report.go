...
func (e EVM) WriteReport(ctx context.Context, metadata capabilities.RequestMetadata, input *pb.WriteReportRequest) (*pb.WriteReportReply, error) {
...
func (e EVM) executeWriteReport(ctx context.Context, metadata capabilities.RequestMetadata, request *pb.WriteReportRequest) (*pb.WriteReportReply, error) {
	...
	case TransmissionStateSucceeded:
		...
		return e.fetchTransactionReceiptAndCreateReply(ctx, *txHash, pb.ReceiverContractExecutionStatus_RECEIVER_CONTRACT_EXECUTION_STATUS_SUCCESS, nil)
	...
	case TransmissionStateFailed:
		...
		if transmissionInfo.GasLimit.Uint64() > receiverGasMinimum {
			...
			return e.fetchTransactionReceiptAndCreateReply(ctx, *txHash, pb.ReceiverContractExecutionStatus_RECEIVER_CONTRACT_EXECUTION_STATUS_REVERTED, nil)
		}
...
func (e EVM) processUnrecoverableTxState(ctx context.Context, request *pb.WriteReportRequest, metadata capabilities.RequestMetadata, txHash evmtypes.Hash, transmissionInfo contracts.TransmissionInfo, transmissionID contracts.TransmissionID, txAttemptedLocally bool) (*pb.WriteReportReply, error) {
	...
	return e.fetchTransactionReceiptAndCreateReply(ctx, txHash, pb.ReceiverContractExecutionStatus_RECEIVER_CONTRACT_EXECUTION_STATUS_REVERTED, message)
}
...
func getTransmissionID(workflowExecutionID string, request *pb.WriteReportRequest) (contracts.TransmissionID, error) {
...
func (e EVM) fetchTransactionReceiptAndCreateReply(ctx context.Context, txHash evmtypes.Hash, receiverStatus pb.ReceiverContractExecutionStatus, errorMessage *string) (*pb.WriteReportReply, error) {
	...
	if receiverStatus.Enum() == pb.ReceiverContractExecutionStatus_RECEIVER_CONTRACT_EXECUTION_STATUS_REVERTED.Enum() && errorMessage == nil {
		message = ptr("Receiver contract execution failure")
	}
	return &pb.WriteReportReply{
		TxHash:                          (txHash)[:],
		TxStatus:                        pb.TxStatus_TX_STATUS_SUCCESS,
		TransactionFee:                  valuespb.NewBigIntFromInt(transactionFee.TransactionFee),
...
func fatalWriteReportReply(message string) *pb.WriteReportReply {
	return &pb.WriteReportReply{
		ErrorMessage: &message,
		TxStatus:     pb.TxStatus_TX_STATUS_FATAL,
	}
...
func validateInputsAndReportMetadata(requestMetadata capabilities.RequestMetadata, request *pb.WriteReportRequest) error {
	if request == nil {
