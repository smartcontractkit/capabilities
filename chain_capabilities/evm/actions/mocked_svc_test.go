...
func InitMocks(t *testing.T) *EvmWithMocks {
	...
	evm, err := NewEVM(config.Config{CREForwarderAddress: randomEVMAddress}, evmSvc, lggr, test.NopBeholderProcessor{}, monitoring.NewMessageBuilder(types.ChainInfo{}, capabilities.CapabilityInfo{}, ""), consensusHandler, 1, limits.Factory{Logger: lggr}, TransmissionScheduler{})
