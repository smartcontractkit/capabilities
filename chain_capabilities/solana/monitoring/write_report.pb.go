...
const file_chain_capabilities_solana_monitoring_write_report_proto_rawDesc = "" +
	"\n" +
	"7chain_capabilities/solana/monitoring/write_report.proto\x12\x16chain_capabilities.evm\x1a'libs/monitoring/execution_context.proto\"\x9f\x01\n" +
	...
	"\x11execution_context\x18\x14 \x01(\v2\x1c.monitoring.ExecutionContextR\x10executionContext\"\xaa\x02\n" +
	"\x12WriteReportRequest\x12R\n" +
	"\x12remaining_accounts\x18\x01 \x03(\v2#.chain_capabilities.evm.AccountMetaR\x11remainingAccounts\x12\x1a\n" +
	"\breceiver\x18\x02 \x01(\fR\breceiver\x12Q\n" +
	"\x0ecompute_config\x18\x03 \x01(\v2%.chain_capabilities.evm.ComputeConfigH\x00R\rcomputeConfig\x88\x01\x01\x12>\n" +
	"\x06report\x18\x04 \x01(\v2&.chain_capabilities.evm.ReportResponseR\x06reportB\x11\n" +
	...
	"\x04sigs\x18\x05 \x03(\v2+.chain_capabilities.evm.AttributedSignatureR\x04sigs\"`\n" +
	"\rComputeConfig\x12#\n" +
...
var file_chain_capabilities_solana_monitoring_write_report_proto_goTypes = []any{
	...
	(*AccountMeta)(nil),                 // 4: chain_capabilities.evm.AccountMeta
	(*ReportResponse)(nil),              // 5: chain_capabilities.evm.ReportResponse
	(*ComputeConfig)(nil),               // 6: chain_capabilities.evm.ComputeConfig
...
var file_chain_capabilities_solana_monitoring_write_report_proto_depIdxs = []int32{
	...
	4,  // 6: chain_capabilities.evm.WriteReportRequest.remaining_accounts:type_name -> chain_capabilities.evm.AccountMeta
	6,  // 7: chain_capabilities.evm.WriteReportRequest.compute_config:type_name -> chain_capabilities.evm.ComputeConfig
	5,  // 8: chain_capabilities.evm.WriteReportRequest.report:type_name -> chain_capabilities.evm.ReportResponse
	7,  // 9: chain_capabilities.evm.ReportResponse.sigs:type_name -> chain_capabilities.evm.AttributedSignature
