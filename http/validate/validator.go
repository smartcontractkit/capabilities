...
func (v *Validator) ValidatedRequest(ctx context.Context, input *protos.Request) (*protos.Request, error) {
	if input == nil {
...
func RequestHeaders(input *protos.Request) error {
...
func validateHeadersMutuallyExclusive(input *protos.Request) error {
...
func (v *Validator) validateInputWithLimiters(ctx context.Context, input *protos.Request) error {
...
func (v *Validator) validatedCacheSettings(ctx context.Context, cacheSettings *protos.CacheSettings) (*protos.CacheSettings, error) {
	if cacheSettings == nil {
		return &protos.CacheSettings{
			Store:  false,
