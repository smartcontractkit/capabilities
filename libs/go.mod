...
require (
	...
	github.com/smartcontractkit/chainlink-common v0.7.1-0.20250710130905-fed89ad656cd
	github.com/smartcontractkit/chainlink-common/pkg/values v0.0.0-20250710130905-fed89ad656cd
