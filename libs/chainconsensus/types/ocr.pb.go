...
func (x *RequestObservation) GetHashable() []byte {
	if x != nil {
		if x, ok := x.Observation.(*RequestObservation_Hashable); ok {
			return x.Hashable
		}
	}
	return nil
...
type RequestObservation_Hashable struct {
...
type Observation struct {
	...
	FeatureEnableMissingRequestRecovery bool                           `protobuf:"varint,4,opt,name=featureEnableMissingRequestRecovery,proto3" json:"featureEnableMissingRequestRecovery,omitempty"`
	unknownFields                       protoimpl.UnknownFields
	sizeCache                           protoimpl.SizeCache
}
...
func (x *Observation) GetFeatureEnableMissingRequestRecovery() bool {
	if x != nil {
		return x.FeatureEnableMissingRequestRecovery
	}
	return false
}
...
func (x *RequestOutcome) GetHashable() []byte {
	if x != nil {
		if x, ok := x.Outcome.(*RequestOutcome_Hashable); ok {
			return x.Hashable
		}
	}
	return nil
...
type RequestOutcome_Hashable struct {
	Hashable []byte `protobuf:"bytes,6,opt,name=hashable,proto3,oneof"`
}
...
func (*RequestOutcome_Hashable) isRequestOutcome_Outcome() {}
...
const file_ocr_proto_rawDesc = "" +
	...
	"\x11missingRequestIDs\x18\x03 \x03(\tR\x11missingRequestIDs\x12P\n" +
	"#featureEnableMissingRequestRecovery\x18\x04 \x01(\bR#featureEnableMissingRequestRecovery\x1aq\n" +
	...
	"\x06errors\x18\x01 \x03(\fR\x06errors\"\xcf\x02\n" +
	...
	"\x05error\x18\x05 \x01(\v2*.chain_capabilities.evm.types.RequestErrorH\x00R\x05error\x12\x1c\n" +
	"\bhashable\x18\x06 \x01(\fH\x00R\bhashableB\t\n" +
	"\aoutcome\"\xce\x01\n" +
	"\aOutcome\x12K\n" +
