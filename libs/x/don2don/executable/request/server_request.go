...
type ServerRequest struct {
	...
	requesters              map[rage.PeerID]bool
	responseSentToRequester map[rage.PeerID]bool
...
func (e *ServerRequest) OnMessage(ctx context.Context, msg *types.MessageBody) error {
	...
	requester, err := don2don.ToPeerID(msg.Sender)
	if err != nil {
...
func (e *ServerRequest) addRequester(from rage.PeerID) error {
...
func (e *ServerRequest) sendResponse(ctx context.Context, requester rage.PeerID) error {
