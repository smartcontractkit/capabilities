...
import (
	...
	types "github.com/smartcontractkit/capabilities/libs/x/don2don/types"
)
...
func (_m *Dispatcher) Send(peerID ragetypes.PeerID, msgBody *types.MessageBody) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(ragetypes.PeerID, *types.MessageBody) error); ok {
...
func (_c *Dispatcher_Send_Call) Run(run func(peerID ragetypes.PeerID, msgBody *types.MessageBody)) *Dispatcher_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ragetypes.PeerID), args[1].(*types.MessageBody))
	})
	return _c
}
...
func (_c *Dispatcher_Send_Call) RunAndReturn(run func(ragetypes.PeerID, *types.MessageBody) error) *Dispatcher_Send_Call {
	_c.Call.Return(run)
	return _c
}
