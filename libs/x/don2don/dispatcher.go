...
type dispatcher struct {
	...
	peerID            rage.PeerID
	signer            rage.Signer
	don2donSharedPeer rage.SharedPeer
...
func NewDispatcher(cfg DispatcherConfig, peerWrapper rage.PeerWrapper, don2donSharedPeer rage.SharedPeer, signer rage.Signer, registry core.CapabilitiesRegistry, lggr logger.Logger) (*dispatcher, error) {
...
func (d *dispatcher) Start(ctx context.Context) error {
	...
	if d.don2donSharedPeer != nil {
		if (d.peerID != rage.PeerID{}) && d.peerID != d.don2donSharedPeer.ID() {
...
func (d *dispatcher) Send(peerID rage.PeerID, msgBody *types.MessageBody) error {
...
func (d *dispatcher) receive() {
	externalPeerRecvCh := make(<-chan rage.Message)
	if d.peer != nil {
...
func (d *dispatcher) handleMessage(ctx context.Context, msg *rage.Message) {
...
func (d *dispatcher) tryRespondWithError(peerID rage.PeerID, body *types.MessageBody, errType types.Error) {
	if body == nil {
		return
	}
