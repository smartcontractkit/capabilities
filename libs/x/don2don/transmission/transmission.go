...
func GetPeerIDToTransmissionDelay(donPeerIDs []rage.PeerID, req capabilities.CapabilityRequest) (map[rage.PeerID]time.Duration, error) {
...
func GetPeerIDToTransmissionDelaysForConfig(donPeerIDs []rage.PeerID, transmissionID string, tc TransmissionConfig) (map[rage.PeerID]time.Duration, error) {
	...
	peerIDToTransmissionDelay := map[rage.PeerID]time.Duration{}
