...
func (_m *PeerWrapper) GetPeer() rage.Peer {
	ret := _m.Called()
	...
	var r0 rage.Peer
	if rf, ok := ret.Get(0).(func() rage.Peer); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(rage.Peer)
		}
	}
...
func (_c *PeerWrapper_GetPeer_Call) Return(_a0 rage.Peer) *PeerWrapper_GetPeer_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PeerWrapper_GetPeer_Call) RunAndReturn(run func() rage.Peer) *PeerWrapper_GetPeer_Call {
	_c.Call.Return(run)
	return _c
}
