...
func (_m *Peer) ID() ragetypes.PeerID {
	ret := _m.Called()
...
func (_c *Peer_ID_Call) Return(_a0 ragetypes.PeerID) *Peer_ID_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Peer_ID_Call) RunAndReturn(run func() ragetypes.PeerID) *Peer_ID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Peer) Receive() <-chan rage.Message {
	ret := _m.Called()
...
func (_c *Peer_Receive_Call) Return(_a0 <-chan rage.Message) *Peer_Receive_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Peer_Receive_Call) RunAndReturn(run func() <-chan rage.Message) *Peer_Receive_Call {
	_c.Call.Return(run)
	return _c
}

// Send provides a mock function with given fields: peerID, msg
func (_m *Peer) Send(peerID ragetypes.PeerID, msg []byte) error {
...
func (_c *Peer_Send_Call) Run(run func(peerID ragetypes.PeerID, msg []byte)) *Peer_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Peer_Send_Call) RunAndReturn(run func(ragetypes.PeerID, []byte) error) *Peer_Send_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Peer) UpdateConnections(peers map[ragetypes.PeerID]rage.StreamConfig) error {
	ret := _m.Called(peers)
...
func (_c *Peer_UpdateConnections_Call) Run(run func(peers map[ragetypes.PeerID]rage.StreamConfig)) *Peer_UpdateConnections_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Peer_UpdateConnections_Call) RunAndReturn(run func(map[ragetypes.PeerID]rage.StreamConfig) error) *Peer_UpdateConnections_Call {
	_c.Call.Return(run)
	return _c
}
