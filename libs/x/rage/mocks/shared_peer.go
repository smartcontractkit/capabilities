...
func (_m *SharedPeer) ID() ragetypes.PeerID {
	ret := _m.Called()
	...
	var r0 ragetypes.PeerID
	if rf, ok := ret.Get(0).(func() ragetypes.PeerID); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ragetypes.PeerID)
		}
	}
...
func (_c *SharedPeer_ID_Call) Return(_a0 ragetypes.PeerID) *SharedPeer_ID_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SharedPeer_ID_Call) RunAndReturn(run func() ragetypes.PeerID) *SharedPeer_ID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *SharedPeer) Receive() <-chan rage.Message {
	ret := _m.Called()
	...
	var r0 <-chan rage.Message
	if rf, ok := ret.Get(0).(func() <-chan rage.Message); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan rage.Message)
		}
	}
...
func (_c *SharedPeer_Receive_Call) Return(_a0 <-chan rage.Message) *SharedPeer_Receive_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *SharedPeer_Receive_Call) RunAndReturn(run func() <-chan rage.Message) *SharedPeer_Receive_Call {
	_c.Call.Return(run)
	return _c
}

// Send provides a mock function with given fields: peerID, msg
func (_m *SharedPeer) Send(peerID ragetypes.PeerID, msg []byte) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(ragetypes.PeerID, []byte) error); ok {
		r0 = rf(peerID, msg)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *SharedPeer_Send_Call) Run(run func(peerID ragetypes.PeerID, msg []byte)) *SharedPeer_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(ragetypes.PeerID), args[1].([]byte))
	})
	return _c
}
...
func (_c *SharedPeer_Send_Call) RunAndReturn(run func(ragetypes.PeerID, []byte) error) *SharedPeer_Send_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *SharedPeer) UpdateConnections(peers map[ragetypes.PeerID]rage.StreamConfig) error {
	ret := _m.Called(peers)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(map[ragetypes.PeerID]rage.StreamConfig) error); ok {
		r0 = rf(peers)
	} else {
		r0 = ret.Error(0)
	}
...
//   - peers map[ragetypes.PeerID]rage.StreamConfig
...
func (_c *SharedPeer_UpdateConnections_Call) Run(run func(peers map[ragetypes.PeerID]rage.StreamConfig)) *SharedPeer_UpdateConnections_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(map[ragetypes.PeerID]rage.StreamConfig))
	})
	return _c
}
...
func (_c *SharedPeer_UpdateConnections_Call) RunAndReturn(run func(map[ragetypes.PeerID]rage.StreamConfig) error) *SharedPeer_UpdateConnections_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateConnectionsByDONs provides a mock function with given fields: ctx, donPairs, streamConfig
func (_m *SharedPeer) UpdateConnectionsByDONs(ctx context.Context, donPairs []rage.DonPair, streamConfig rage.StreamConfig) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []rage.DonPair, rage.StreamConfig) error); ok {
...
func (_c *SharedPeer_UpdateConnectionsByDONs_Call) Run(run func(ctx context.Context, donPairs []rage.DonPair, streamConfig rage.StreamConfig)) *SharedPeer_UpdateConnectionsByDONs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]rage.DonPair), args[2].(rage.StreamConfig))
	})
	return _c
}
...
func (_c *SharedPeer_UpdateConnectionsByDONs_Call) RunAndReturn(run func(context.Context, []rage.DonPair, rage.StreamConfig) error) *SharedPeer_UpdateConnectionsByDONs_Call {
	_c.Call.Return(run)
	return _c
}
