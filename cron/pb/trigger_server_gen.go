...
type CronCapability interface {
	RegisterTrigger(ctx context.Context, triggerID string, metadata capabilities.RequestMetadata, input *Config) (<-chan capabilities.TriggerAndId[*Payload], error)
	UnregisterTrigger(ctx context.Context, triggerID string, metadata capabilities.RequestMetadata, input *Config) error

	RegisterLegacyTrigger(ctx context.Context, triggerID string, metadata capabilities.RequestMetadata, input *Config) (<-chan capabilities.TriggerAndId[*LegacyPayload], error)
	UnregisterLegacyTrigger(ctx context.Context, triggerID string, metadata capabilities.RequestMetadata, input *Config) error
