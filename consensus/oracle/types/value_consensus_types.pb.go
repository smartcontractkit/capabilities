...
const (
	...
	ConsensusFailureCode_INVALID_TYPE_FOR_MEDIAN_AGGREGATION                 ConsensusFailureCode = 6
)
...
var (
	ConsensusFailureCode_name = map[int32]string{
		...
		6: "INVALID_TYPE_FOR_MEDIAN_AGGREGATION",
	}
	ConsensusFailureCode_value = map[string]int32{
		...
		"INVALID_TYPE_FOR_MEDIAN_AGGREGATION":                 6,
	}
)
...
const file_value_consensus_types_proto_rawDesc = "" +
	...
	"\x11REPORT_GENERATION\x10\x01*\x8a\x02\n" +
	...
	"#INVALID_TYPE_FOR_MEDIAN_AGGREGATION\x10\x06B\x18Z\x16consensus/oracle/typesb\x06proto3"
