...
type RequestObservation struct {
	...
	RemoveLibUseInFailureMessageFormatting bool                       `protobuf:"varint,4,opt,name=RemoveLibUseInFailureMessageFormatting,proto3" json:"RemoveLibUseInFailureMessageFormatting,omitempty"` // remove use of libraries in failure message formatting; flag to be removed after rollout
	unknownFields                          protoimpl.UnknownFields
	sizeCache                              protoimpl.SizeCache
}
...
func (x *RequestObservation) GetRemoveLibUseInFailureMessageFormatting() bool {
	if x != nil {
		return x.RemoveLibUseInFailureMessageFormatting
	}
	return false
}
...
const file_value_consensus_types_proto_rawDesc = "" +
	...
	"receivedAt\x12V\n" +
	"&RemoveLibUseInFailureMessageFormatting\x18\x04 \x01(\bR&RemoveLibUseInFailureMessageFormatting\"\xd3\x01\n" +
	"\vObservation\x12X\n" +
