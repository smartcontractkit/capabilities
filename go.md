...
flowchart LR
	...
	capabilities/http --> capabilities/libs
	click capabilities/http href "https://github.com/smartcontractkit/capabilities"
	...
	chain_capabilities/evm --> chainlink-common/pkg/values
	chain_capabilities/evm --> freeport
