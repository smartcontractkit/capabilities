...
flowchart LR
	...
	chainlink-ton --> chainlink-ccip/chains/solana
	chainlink-ton --> chainlink-deployments-framework
	chainlink-ton --> chainlink-protos/job-distributor
	chainlink-ton --> chainlink-sui
	chainlink-ton --> chainlink-tron/relayer
	chainlink-ton --> mcms
