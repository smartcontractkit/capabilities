...
func setupCronTestDon(ctx context.Context, t *testing.T, lggr logger.SugaredLogger,
	...
	cronSchedule string, targetSink framework.TargetFactory, kvstorePath string, cronPath string) (workflowDon *framework.DON) {
	...
	workflowDon.AddStandardCapability("kvstorecap-capabilities", kvstorePath, "")
