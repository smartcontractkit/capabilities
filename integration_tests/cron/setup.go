...
func setupCronTestDon(ctx context.Context, t *testing.T, lggr logger.SugaredLogger,
	...
	cronSchedule string, targetSink framework.TargetFactory) (workflowDon *framework.DON) {
	...
	workflowDon.AddStandardCapability("kvstore-capabilities", "../../bin/kvstore", "")

	workflowDon.AddStandardCapability("cron-capabilities", "../../bin/cron", "")
