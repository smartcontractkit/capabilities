...
func Test_CronTrigger(t *testing.T) {
	...
	kvstoreBinary, err := utils.DeployCapability(t, "kvstore")
	...
	setupCronTestDon(ctx, t, lggr, workflowDonConfiguration, scheduleEveryOtherSecond, targetSink, kvstoreBinary, cronBinary)
